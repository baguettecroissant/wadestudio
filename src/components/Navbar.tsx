            ...
            >
                <nav className="relative flex items-center justify-between px-6 py-3 rounded-full bg-zinc-900/80 border border-zinc-800 backdrop-blur-xl shadow-2xl w-full max-w-3xl">
                    ...
                    <div className="hidden md:block">
                        <Link href="#contact" className="px-5 py-2 rounded-full bg-white text-zinc-950 font-semibold text-sm hover:bg-zinc-200 transition-colors">
                            Let's Talk
                        </Link>
                    </div>
            ...
            {isMobileMenuOpen && (
                ...
                >
                    ...
                    <ul className="flex flex-col items-center gap-8 text-2xl font-bold font-heading">
                        <li onClick={() => setIsMobileMenuOpen(false)}><Link href="#works">Work</Link></li>
                        <li onClick={() => setIsMobileMenuOpen(false)}><Link href="#services">Services</Link></li>
                        <li onClick={() => setIsMobileMenuOpen(false)}><Link href="#process">Process</Link></li>
                        <li onClick={() => setIsMobileMenuOpen(false)}><Link href="#about">About</Link></li>
                        <li onClick={() => setIsMobileMenuOpen(false)} className="pt-8">
                            <Link href="#contact" className="px-8 py-3 rounded-full bg-indigo-600 text-white text-lg">
                                Let's Talk
                            </Link>
                        </li>
                    </ul>
